...
FormulaLexer.ADD = 3;
FormulaLexer.SUB = 4;
FormulaLexer.LPAREN = 5;
FormulaLexer.RPAREN = 6;
FormulaLexer.ID = 7;
FormulaLexer.INT = 8;
FormulaLexer.EQ = 9;
FormulaLexer.SEMI = 10;
FormulaLexer.COMMENT = 11;
FormulaLexer.WS = 12;
...
FormulaLexer.prototype.literalNames = [null, "'*'", "'/'", "'+'", "'-'", "'('", "')'", null, null, "'='", "';'"];

FormulaLexer.prototype.symbolicNames = [
    null,
    "MUL",
    "DIV",
    "ADD",
...
FormulaLexer.prototype.ruleNames = [
    "MUL",
    "DIV",
    "ADD",
    "SUB",
